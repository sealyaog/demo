...
import "sort"
import "fmt"
//In order to sort by a custom function in Go, we need a corresponding type. Here we have created a ByLength type that is just an alias for the builtin []string type.
