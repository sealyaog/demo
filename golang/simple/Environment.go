...
import "fmt"
func main() {
    //To set a key/value pair, use os.Setenv. To get a value for a key, use os.Getenv. This will return an empty string if the key is not present in the environment.
    os.Setenv("FOO", "1")
