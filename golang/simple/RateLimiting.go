...
import "fmt"
func main() {
    //First we will look at basic rate limiting. Suppose we want to limit our handling of incoming requests. We will serve these requests off a channel of the same name.
