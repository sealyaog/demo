...
func main() {
    ...
    fmt.Printf("|%6d|%6d|\n", 12, 345)
    //You can also specify the width of printed floats, though usually you will also want to restrict the decimal precision at the same time with the width.precision syntax.
